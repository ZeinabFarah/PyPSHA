...
3. **Ground-Motion-Equation (GME) Model**: Calculate median ground-motion intensities and the standard deviations of inter-event and intra-event residuals.
4. **Inter-Event and Intra-Event Residuals**: Generate normalized residuals for the seismic events.
5. **Intensity Measure (IM)**: Compute the intensity measure values for the earthquake scenarios.
